...
sudo apt-get -y install filezilla mysql-workbench neovim vlc build-essential snapd
sudo apt-get -y install htop screenfetch openjdk-11-jdk openjfx composer 
sudo apt-get -y install wget docker.io docker-compose curl mongodb
